...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <a href="produits.php"><div class="w3-quarter">
    ...
    <a href="category.php"><div class="w3-quarter">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row">
      ...
      <div class="w3-col m10 w3-container">
        <h4><?php echo $recentProduit->lib_produit.' ajouté le  ';?><span class="w3-opacity w3-medium"><?php $date_creation=strtotime($recentProduit->date_creation);
