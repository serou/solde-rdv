...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> My Dashboard- Gestions des Formules</b></h5>
  </header>

  <!--affichage et permettre la modification-->
  <?php if(!empty($clientformules)) {?>

          <?php foreach ($clientformules as $clientformule) : ?>
         <div class="col-md-4 col-sm-4">
          <h2 style="text-align:center">Profil Client</h2>

          <div class="card">
            <img src="../common/images/client-map/<?php echo $clientformule->image_client;?>.jpg"  style="width:100%">
            <h1><strong>Login </strong> :<?php echo $clientformule->login; ?></h1>
            <strong>Password </strong> :<?php echo $clientformule->password; ?>
            <p><strong>Mail</strong>:<?php echo $clientformule->email; ?></p>
            <p><strong>Nom</strong>:<?php echo $clientformule->nom_client; ?></p>
            <p><strong>Prenom</strong>:<?php echo $clientformule->prenom_client; ?></p>
            <p><strong>Contact 1</strong>:<?php echo $clientformule->contact_1; ?></p>
            <p><strong>Contact 2</strong>:<?php echo $clientformule->contact_2; ?></p>
            <p><strong>Adresse postale 2</strong>:<?php echo $clientformule->adress_postal; ?></p>
          
           <p><a class="myBtn" href="attribuerFormule.php?code_client=<?php echo $clientformule->code_client;?>"><button class="btn btn-primary ">Modifier Rôle</button></a></p>
          </div>
         </div>
          <?php endforeach; ?>
            ...
            <div id="myModal" class="modal1">
                <!-- Modal content-->
                  ...
                  <div class="modal1-content">
                    ...
                    <a href="attribuerFormule.php"><button type="button" class="close" data-dismiss="modal">&times;</button></a>
                    <h3 >Modification des Rôles</h4>
                  </div>
                  <div class="modal1-body">
                    <form action="attribuerFormule.php?code_client=<?php echo $clientformule->code_client; ?>" method="post" enctype="multipart/form-data">
                        
                        <div class="form-group">
                          <label for="inputNomClient"><strong>Nom client : </strong><?php echo strtoupper(nl2br(stripslashes($info->nom_client))); ?></label>
                        ...
                        <div class="form-group">
                          <img src="../common/images/client-map/<?php echo $info->image_client;?>.jpg" width="110" heigth="110" /><br>
                        </div> 
                        <br>
                        <div class="form-group">
