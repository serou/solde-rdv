				...
				<div class="col-md-7 col-sm-7 col-sm-offset-2 markers">
					...
					<div class="todo">
						...
						<span class="update" id="<?php echo $typestructure->code_type_structure;?>">
							<a onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black" href="typeStructureUpdate.php?code_type_structure=<?php echo $typestructure->code_type_structure;?>">
