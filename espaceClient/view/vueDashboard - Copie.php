...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <span class="w3-bar-item w3-right">Logo --- <?php echo "Nombre de visiteurs " . $compte; ?></span>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-row-padding w3-margin-bottom">
    ...
    <a href="client.php"><div class="w3-quarter">
  ...
  <div class="w3-row-padding w3-margin-bottom">
    <a href="structure.php"><div class="w3-quarter">
